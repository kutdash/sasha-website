...
export const MODULES = [
  ...
  },
  {
    ...
    description: 'настройки камеры, монтаж с нуля в Adobe Premiere Pro из моих исходников, фишки съёмки',
  },
  {
    title: 'упаковка блога',
    description: 'упакуешь блог под себя и научишься снимать рилсы, которые залетают и приводят клиентов',
  },
  {
    title: 'основы продаж',
    description: 'создание офферов, отработка возражений, поиск клиентов · воркшоп по продажам для личного и группового тарифа',
  },
  {
    title: 'наработка портфолио',
    description: 'рассмотрим способы упаковки портфолио · сделаем с нуля 5 коммерческих видео, которые наполнят портфолио',
  },
  {
    title: 'основы продюсирования',
    description: 'как делать съёмки под ключ · воркшоп-сопровождение по продюсированию съёмки для личного тарифа',
  },
  {
