...
export const OUTCOMES = [
  ...
  },
  {
    ...
    description:
      'пройдём все этапы создания съёмки для реального клиента или творческой. придумаем идею, найдём клиента, презентуем идею и организуем съёмку. я буду с тобой онлайн на всех этапах, кроме самой съёмки — на неё ты пойдёшь с чётким планом задач, без стресса и вопросов в голове',
...
export const ROUTES = [
  ...
  },
  {
    ...
    items: [
      'проходи маршруты 1 и 2 целиком, в том же порядке',
    ],
